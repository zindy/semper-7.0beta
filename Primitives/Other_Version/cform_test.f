...
C
      REAL B2(512)
C      INTEGER*2 IB1(256),IB2(256),oldf,newf
      INTEGER IB1(256),IB2(256),oldf,newf
      INTEGER*4 I4256
      PARAMETER (I4256=256)
...
C Copy to B2 via CFORM
   ...
   40 FORMAT (/' calling cform(ib1,ib2,1,1,256)')
      ...
      DO N=1,NFORMS
        NEWF=FORMS(N)
        write(*,*)'Test ',it1,NEWF,N,NFORMS
        CALL CFORM(IB1,IB2,IT1,NEWF,I4256)
        write(*,*)1,NEWF,IB2(1:5),B2(1:5)
        CALL CFORM(B3,IB2,2,NEWF,I4256)
        write(*,*)2,NEWF,IB2(1:5),B2(1:5)
      enddo
      CALL CFORM(IB1,IB2,it1,it1,I4256)
C     write(*,*)IB2(1:5),B2(1:5)
