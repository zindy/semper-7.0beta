...
static uint32_t redMap[256];
static uint32_t greenMap[256];
static uint32_t blueMap[256];
...
*/
	...
	for ( i = 0; i < cellCount; i++ )
	{
	    redMap   [ i ] = (uint32_t) XimRed   [ 0 ] [ i ] << frameTrueColorRedShift;
	    greenMap [ i ] = (uint32_t) XimGreen [ 0 ] [ i ] << frameTrueColorGreenShift;
	    blueMap  [ i ] = (uint32_t) XimBlue  [ 0 ] [ i ] << frameTrueColorBlueShift;
	}
	...
	for ( j = 0; j < 8; j++ )
	{
	    red   = (uint32_t) XovRed   [ j ] << frameTrueColorRedShift;
	    green = (uint32_t) XovGreen [ j ] << frameTrueColorGreenShift;
	    blue  = (uint32_t) XovBlue  [ j ] << frameTrueColorBlueShift;
...
*/
    ...
    (void) XSetForeground(termDisplay, pixmapGC, (uint32_t) 1);
...

{
	...
	for ( i = 0; i < cellCount; i++ )
	{
	    redMap   [ i ] = (uint32_t) XimRed   [ j ] [ i ] << frameTrueColorRedShift;
	    greenMap [ i ] = (uint32_t) XimGreen [ j ] [ i ] << frameTrueColorGreenShift;
	    blueMap  [ i ] = (uint32_t) XimBlue  [ j ] [ i ] << frameTrueColorBlueShift;
	}
...
*/
		    ...
		    {
			red   = (uint32_t) XovRed   [ j ];
			green = (uint32_t) XovGreen [ j ];
			blue  = (uint32_t) XovBlue  [ j ];
