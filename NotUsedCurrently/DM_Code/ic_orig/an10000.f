...
c  local variables
      ...
      integer*2 imagetype     ! word 0
      integer*2 headerlength  ! word 1
      integer*2 mhorder       ! word 2
      integer*2 hd1           ! word 3
      integer*2 hd2           ! word 4
...
c      integer*1 xzeroi1(0:3)  ! words 9-10
      ...
      integer*2 iscale        ! word 29
      integer*2 nscale        ! word 30
      integer*2 livetime      ! X-ray spectrum word 36
      integer*2 realtime      ! " word 37
      integer*4 cpsec         ! " word 39-40
      integer*2 vd1           ! Linescan word 36
      integer*2 vd2           ! Linescan word 37
