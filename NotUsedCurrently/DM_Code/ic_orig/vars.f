...
c  Max size of 2D images assuming 4 bytes/pixel and square
      integer maxsiz, maxarg, bufsiz, charlen
...
c  rgb byte 3 layer  n   by n by 3  n*n by 3
      ...
      integer*2   im1di2(0:2*maxsiz*maxsiz-1)
      ...
      integer*2   imagc2(0:maxsiz/2-1, 0:maxsiz-1, 0:2)
...
c  here evzero is converted to be the leftmost real channel
      integer*2 choff                  ! channel offset
      integer*2 pbyte                  !*bytes/pixel
      character ptype*1                !*i=int, f=float, c=complex
c                                        r=rgb
      integer*2 psign                  !*0=unsigned, 1=signed
...
c  semper variables, all need to be i2
      integer*2 ncol, nrow, nlay, iclass, iform, ntitle, ilabel
      integer*2 iversn, iflag, blim, iccoln
      integer*2 labeli2(256)
      integer*2 iyear, imonth, iday, ihour, iminut, isec
      integer*4 tarray(9)
