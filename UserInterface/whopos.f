c----------------------------------------------------------------------
c
c	LOGICAL FUNCTION WHOPOS ( DEVICE, WID, XPOS, YPOS )
c       ---------------------------------------------------
c
c	PARAMETERS:
c
...
c----------------------------------------------------------------------
c
      logical function whopos ( device, wid, xpos, ypos )
c     ===================================================
c
      integer device
      integer wid
...
c     CALLED FUNCTIONS:
c
c     Moves a window on the host screen
      logical wdxpos
c
      whopos = wdxpos ( device, wid, xpos, ypos )
c
      return
      end
c
