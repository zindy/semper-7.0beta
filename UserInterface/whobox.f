c----------------------------------------------------------------------
c
c	LOGICAL FUNCTION WHOBOX ( DEVICE, WID, WIDTH, FGC, BGC,
...
c                              coordinates
c
c	Draws a box to the requested window on the host device, in the
c       appropriate colours and style.  If requested, a string will be
c       written into the top edge of the box.
c
c	Function returns FALSE if sucessful, otherwise TRUE.
c
c----------------------------------------------------------------------
c
      logical function whobox ( device, wid, width, fgc, bgc,
