...
c----------------------------------------------------------------------
c
c	LOGICAL FUNCTION WFSCLR ( DEVICE,COLOUR,WID,XPOS,YPOS,
c                                 XSIZE,YSIZE )
c       -------------------------------------------------------
c
c	PARAMETERS:
...
c----------------------------------------------------------------------
c
      logical function wfsclr (device,wid,colour,xpos,ypos,xsize,ysize)
c     =================================================================
c
      integer device
      integer wid
...
c     Clears a window on a dumb screen
      logical wdxclr
c
      wfsclr = wdxclr ( device,wid,colour,xpos,ypos,xsize,ysize )
      return
c
