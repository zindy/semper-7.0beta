c----------------------------------------------------------------------
c
c	LOGICAL FUNCTION WFSTEX ( DEVICE,WID,FGC,BGC,STYLE,XPOS,YPOS,
c                                 STRING, LENGTH )
c       ---------------------------------------------------------------
c
c	PARAMETERS:
...
c       colours and style, on the framstore device.
c
c	Function returns FALSE if sucessful, otherwise TRUE.
c
c----------------------------------------------------------------------
c
      logical function wfstex ( device, wid, fgc, bgc, style, xpos,
     +                          ypos, string, length )
c     ==========================================================
c
