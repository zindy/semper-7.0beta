...
C
         ...
         ENDIF
C
C Fault access to existing demo device
C
         IF (LDEMO) THEN
            ERROR=120
            GOTO 50
...
C
C Fault demo checksum
C
         SUM1=HEADER(17)+HEADER(18)
         SUM2=HEADER(15)+HEADER(16)
C
         IF (AND(SUM1,255).EQ.HEADER(19).OR.
     +       AND(SUM2,255).EQ.HEADER(20)) THEN
            ERROR=120
            GOTO 50
         ENDIF
C
...
C
         ...
         SUM2=HEADER(15)+HEADER(16)
C
         HEADER(19)=AND(SUM1,255)
         HEADER(20)=AND(SUM2,255)
C
