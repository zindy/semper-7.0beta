...
C
      ...
      LOGICAL SEMOPN,SEMROW,VARSET,OPT,SEMCON
C
...
C
      ...
      ENDIF
C
      IF (LONGF(NC1) .GT. (LNBUF / LNREA4)) THEN
         ERROR = 5
         GOTO 130
      ENDIF
C
...
C
      ...
      IX = LNGONE
      DO 90 I = 1, 2
         IF (SEMROW(2, IB6(IX), NFMINT, I, 1, LPB)) GOTO 130
...
C
         ...
         LNNELS = LONGF(NELS)
         DO 100 I = 1, 2
            IF (SEMROW(1,IB6(IX),NFMINT,I,1,LPB)) GOTO 130
