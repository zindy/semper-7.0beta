...
C
      LOGICAL CLSOVP, SEMOPN, SEMROW, SEMROWI, TSTSRG, SEMDIA
      INTEGER IVAL, IVALPN, SEMFRM
      EXTERNAL CLSOVP, IVAL, IVALPN, SEMFRM, SEMOPN, SEMROW, SEMROWI, TSTSRG
C
...
C
   ...
   90     IX0 = IX0 + (STEP)
  100   CONTINUE
        IF (SEMROWI(2, IB5, NFMINT, I, 1, LP)) GOTO 120
        BASE = BASE + STEP
  110 CONTINUE
  120 RETURN
C
