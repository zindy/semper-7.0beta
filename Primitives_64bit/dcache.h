...
typedef          int32_t   SegmentIndex;
typedef          int32_t   CacheIndex;
typedef          int32_t   SegmentSize;
typedef          int32_t   BlockNumber;
typedef          int32_t   DeviceSize;
typedef          int32_t   MemorySize;
